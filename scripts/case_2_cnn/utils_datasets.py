...
def scale_data(x, y, feature_range=(0.0, 1.0)):
    return _linear_scale(x, feature_range), _linear_scale(y, feature_range)


def split_data(x, y, train_split=TRAIN_SPLIT, validation_split=VALIDATION_SPLIT):
...
def create_datasets(data_path=DATA_PATH, train_split=TRAIN_SPLIT,
                    validation_split=VALIDATION_SPLIT, scale_range=(0.0, 1.0),
                    **_legacy_options):
